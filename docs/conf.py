...
project = u'Matrix Cascade Equations (MCEq)'
copyright = u'2017, Anatoli Fedynitch'
...
latex_documents = [
    ('index', 'MatrixCascadeEquationMCEq.tex',
     u'Matrix Cascade Equation (MCEq) Documentation', u'Anatoli Fedynitch',
     'manual'),
]
...
man_pages = [('index', 'matrixcascadeequationmceq',
              u'Matrix Cascade Equation (MCEq) Documentation',
